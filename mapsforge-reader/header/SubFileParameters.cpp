...
namespace carto {
    ...
    SubFileParameters::SubFileParameters(const SubFileParameterBuilder &subFileParameterBuilder) {
        ...
        MapPos projectedTopLeft = subFileParameterBuilder._bounding_box.getMin();
        MapPos projectedBottomRight = subFileParameterBuilder._bounding_box.getMax();
        ...
        _boundary_tile_bottom = topLeftTile.getY();
        _boundary_tile_top = bottomRightTile.getY();
        _boundary_tile_left = topLeftTile.getX();
        _boundary_tile_right = bottomRightTile.getX();
