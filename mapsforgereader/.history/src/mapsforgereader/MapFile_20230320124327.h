...
namespace carto {
    namespace mapsforge {
        ...
        public:
            ...
            typedef cglib::bbox2<double> MapBounds2D;
            typedef cglib::bbox3<double> MapBounds3D;
             ...
             */
            const MapBounds2D &getMapBounds() const;
        ...
        private:
             ...
             */
            bool
            processPois(const MapPos &tileOrigin, uint32_t numberOfPois, const MapBounds2D &mapBounds, bool filterRequired,
             ...
             * @return
             */
            bool processWays(const QueryParameters &queryParams, uint32_t numberOfWays, const MapBounds2D &mapBounds,
                             bool filterRequired,
        ...
        private:
             ...
             */
            std::shared_ptr <AbstractProjection> _projection;
